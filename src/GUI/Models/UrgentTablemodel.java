 ...
 * @author Rashid
 */
public class UrgentTablemodel extends AbstractTableModel
{
    private final String[] header = {"Order", "DueDate", "MaterialName", "Circumference", "Width", "Quantity", "Cut", "Status"};
    ...
    public UrgentTablemodel(ArrayList<Order> allInfo)
    {
        info = allInfo;
    }

    public UrgentTablemodel(List<Order> all)
    {
